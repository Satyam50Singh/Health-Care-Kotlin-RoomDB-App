...
object Utils {
    ...
    fun userLogout(context: Context) {
        val builder = AlertDialog.Builder(context)
            ...
            .setTitle(context.getString(R.string.logout)).setCancelable(false)
    ...
    fun setAppTheme(context: Context, isDarkModeEnabled: Boolean) {
        ...
        PreferenceManager.setSharedPreferences(
            context, Constants.PREF_DARK_MODE_VALUE, isDarkModeEnabled
        )
    }
    ...
    fun getPhysiciansList(): ArrayList<DoctorListModel> {
        ...
        doctorsList.add(
            DoctorListModel(
                101,
                "Dr. Archana",
                "An alumnus from Armed Forces Medical College with vast experience in professional field from base to apex levels. Also possess Post Graduate Diploma in Health Care Management and Fellowship in Rural Health . Amongst the very few with leadership experience in most challenging operational military medical environments.Background lies in ensuring lowest mortality and morbidity by adopting protocols to achieve peak medical management levels. Excel at provision of compassionate medical care with a holistic and ethical approach. ",
                "786868669",
                30.3165,
                78.0322,
                "Physicians"
        ...
        doctorsList.add(
            DoctorListModel(
                102,
                "Dr. Arnav Malhotra",
                "An alumnus from Armed Forces Medical College with vast experience in professional field from base to apex levels. Also possess Post Graduate Diploma in Health Care Management and Fellowship in Rural Health . Amongst the very few with leadership experience in most challenging operational military medical environments.\nBackground lies in ensuring lowest mortality and morbidity by adopting protocols to achieve peak medical management levels. Excel at provision of compassionate medical care with a holistic and ethical approach.",
                "786868669",
                30.3165,
                78.0322,
                "Physicians"
    ...
    fun getHealthArticles(): ArrayList<HealthArticleEntity> {
        val healthArticleList = ArrayList<HealthArticleEntity>()
